...
articles.forEach(article => {
    ...
    bookarticle.innerHTML = `
        <div class="articletop">
                <p class="releasedate">${article.date}</p>
            ...
            <div class="articlemain">
                ...
                <img class="cover" src="${article.imgSrc}"
                alt="${article.imgAlt}">
                <p class="desc">${article.description}
                </p>
            </div>
      `;

    booksList.appendChild(bookarticle)
});

const spans = document.querySelectorAll('article.book span');
